...
contract SmartXCP is ERC20{
    ...
    event RXCPburned(string XCP_Address, address from, uint amount);
    ...
    function mint(string memory XCP_txHash, string memory XCP_Address, uint amount, address to) public{
        require(is_XCP_deposit_minted[XCP_txHash]==false,"Deposit has already been minted using this Transaction Hash");
    ...
    function confirmSend(uint burnId, string memory _XCP_txHash) public{
        require(minters[msg.sender]==true, "Must be Minter");
